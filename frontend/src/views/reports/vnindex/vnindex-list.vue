...
import VnindexCreateOrEdit from "./vnindex-create-or-edit.vue";
...
export default {
  ...
  methods: {
    async deleteList() {
      ...
      try {
        await this.$callApi.post("/api/vnindexpicks/deleteList", {
          ids: selectedItems,
        });
