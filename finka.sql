...
-- Thời gian đã tạo: Th1 09, 2025 lúc 10:36 AM
...
CREATE TABLE `stockdetails` (
  `id` int NOT NULL,
  `stockCode` varchar(64) COLLATE utf8mb4_bin NOT NULL,
...
(4, 'SHK', 'Chứng khoán', 'Tốt', '25-02', '2025-01-09 17:04:03', '2025-01-09 17:04:03');
...
CREATE TABLE `users` (
  ...
  `codeLiked` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
(5, '2024-11-28 00:00:00', 1239.20, 0.50, 'Bán', 10, 'Rất thấp', 'Rất thấp', 13.00, 1.77, '2025-01-05 19:57:09', '2025-01-09 16:23:23');
